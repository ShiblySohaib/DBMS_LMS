...
c.execute("create table if not exists users (user_name varchar(50),user_pass varchar(50))")
...
user_type = easygui.buttonbox("Select User typer.", choices=['Admin','Librarian', 'Student'])
